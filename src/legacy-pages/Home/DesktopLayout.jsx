...
const DesktopLayout = ({ branding1, logoVertical, starImage, interiorismo1, arquitectura1, groupImage, teamImage, projectCount, yearsCount, countriesCount, citiesCount, goToProject, goToProjects, goToAwardsAndPress, goToStudio }) => {
    return (
            ...
            <section className="image-and-quadrants desktop-hide">
                <div className="quadrant-container">
                    <div className="quadrant white-box">
                        <span className="project-box">Desktop Inspiring</span>
                ...
                <div className="custom-quadrant-container">
                    ...
                    <div className="quadrant custom-white-box" onClick={goToStudio}>
                        <span className="text-Awards">Our Studio</span>
                    </div>
                </div>
